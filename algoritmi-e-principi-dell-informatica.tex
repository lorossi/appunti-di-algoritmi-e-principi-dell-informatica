...
\begin{itemize}
  ...
  \item Il numero di massimo di archi in un grafo è:
        \begin{itemize}
          \item per i grafi non \textbf{orientati} \(2 \cdot \dfrac{|E|}{|V|(|V|-1)}\)
          \item per i grafi \textbf{orientati} \(\dfrac{|E|}{|V|(|V|-1)}\)
        \end{itemize}
\end{itemize}
...
\begin{minipage}{\textwidth}
  ...
  \begin{minipage}[t]{0.32\textwidth}
    \begin{lstlisting}[style=pseudocode, basicstyle=\footnotesize\ttfamily, caption={Ricerca}, label={lst:search-dizionario}]
DIRECT-ADDRESS-SEARCH(T, k)
  return T[k]
\end{lstlisting}
  \end{minipage}
  \begin{minipage}[t]{0.32\textwidth}
    \begin{lstlisting}[style=pseudocode, basicstyle=\footnotesize\ttfamily, caption={Inserimento}, label={lst:insert-dizionario}]
DIRECT-ADDRESS-INSERT(T, k)
  T[x.key] = x
\end{lstlisting}
  \end{minipage}
  \begin{minipage}[t]{0.32\textwidth}
    \begin{lstlisting}[style=pseudocode, basicstyle=\footnotesize\ttfamily, caption={Cancellazione}, label={lst:delete-dizionario}]
...
\begin{minipage}{\textwidth}
\begin{lstlisting}[style=pseudocode, basicstyle=\footnotesize\ttfamily, caption={Ricerca}, label={lst:chained-hash-search}]
  CHAINED-HASH-SEARCH(T, k)
    cerca un elemento con chiave k nella lista T[h(k)]
  \end{lstlisting}
  \begin{lstlisting}[style=pseudocode, basicstyle=\footnotesize\ttfamily, caption={Inserimento}, label={lst:chained-hash-insert}]
CHAINED-HASH-INSERT(T, x)
  inserisci X in testa alla lista T[h(x.key)]
\end{lstlisting}
  \begin{lstlisting}[style=pseudocode, basicstyle=\footnotesize\ttfamily, caption={Cancellazione}, label={lst:chained-hash-delete}]
