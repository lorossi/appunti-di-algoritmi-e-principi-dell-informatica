...
\[ 0 \leq |E| \leq |V|^2 \]
Un grafo è detto \textbf{denso} se il numero di lati è \inlinequote{abbastanza vicino} al numero massimo di lati, cioè quindi quando è verificata la relazione \(|E| \approx |V|^2\).
