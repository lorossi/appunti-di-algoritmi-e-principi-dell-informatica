...
Poiché essi modificano l'albero, la struttura risultante da queste operazioni potrebbe violare le proprietà elencate nella Sezione~\ref{sec:alberi-rosso-neri}.
...
\begin{table}[htbp]
  ...
  \begin{tabular}{c|c|c|c}
    ...
    \BST                    & \(\bigO(h) = \bigO(\log(n))\) & \(\bigO(h) = \bigO(\log(n))\) & \(\bigO(h) = \bigO(\log(n))\) \\
